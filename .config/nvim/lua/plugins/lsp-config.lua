    ...
    },
    {
        ...
        config = function()
            require("mason-lspconfig").setup({
                ensure_installed = { "lua_ls", "html", "ts_ls", "cssls", "pyright", "emmet_ls", "tailwindcss", "terraformls" },
            })
        end,
    },
    {
        ...
        config = function()
            require("mason-tool-installer").setup({
                ensure_installed = { "prettierd", "eslint_d", "debugpy", "black", "isort", "pylint", "tflint" },
            })
        end,
    },
    {
