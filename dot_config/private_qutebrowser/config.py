...
config.bind('<Space>sg', 'set completion.open_categories ["history"] ;; cmd-set-text -s :open -t -s')
config.bind('<Space>o', 'set completion.open_categories [] ;; cmd-set-text -s :open -t -s')
