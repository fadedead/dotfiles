...
c.colors.completion.category.border.top = c.colors.completion.category.border.bottom = base
...
c.colors.completion.item.selected.border.top = c.colors.completion.item.selected.border.bottom = iris
...
c.colors.statusbar.caret.selection.bg, c.colors.statusbar.caret.selection.fg = iris, base
...
# Tabs
c.tabs.position, c.tabs.width, c.tabs.padding = 'left', '10%', {'top': 6, 'bottom': 6, 'left': 8, 'right': 8}
...
# Fonts
font_default = '10pt "JetBrainsMono Nerd Font"'
c.fonts.default_family = 'JetBrainsMono Nerd Font'
c.fonts.default_size = '10pt'
c.fonts.statusbar = c.fonts.tabs.selected = c.fonts.tabs.unselected = c.fonts.hints = font_default
...
config.bind('<Space>sg', 'set completion.open_categories ["history"] ;; cmd-set-text -s :open -t')
config.bind('<Space>o', 'cmd-set-text -s :open -t')
config.bind('<Space>hl', 'set completion.open_categories ["bookmarks"] ;; cmd-set-text -s :open -t')
